...
jPanel3.add(friendsPostsLabel);  // إضافة الـ JLabel إلى الـ JPanel
    for (String post : manager.getPosts()) {
    // إنشاء JLabel لكل بوست
    JLabel postLabel = new JLabel(post);
    postLabel.setForeground(Color.black);  
    jPanel3.add(postLabel);  // إضافة الـ JLabel إلى الـ JPanel
}
...
jButton4.addActionListener(e -> {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(coverImageFrame1, javax.swing.GroupLayout.PREFERRED_SIZE, 1013, javax.swing.GroupLayout.PREFERRED_SIZE)
